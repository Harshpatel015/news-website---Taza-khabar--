...
function Space(props) {
    ...
    useEffect(()=>{
      axios.get("https://newsapi.org/v2/everything?q=(space%20AND%20isro)&from=2023-08-27&to=2023-08-24&apiKey=c261f27321f04afbbc65e2e975aaef76").then((res) =>{
              ...
              News.map((val)=>{
                ...
                return(
                  <div className='col-md-4 my-2'>
                      ...
                      <div className="card" style={{width:"21rem" ,color:props.theam === "dark"?"#E4E4E4":"#434343",backgroundColor:props.theam ===  "dark"?"black":"white"}}>
                        <img src={img()} className="card-img-top" alt="..."/>
                          <div className="card-body">
                            <h5 className="card-title" style={{color:props.theam === "dark"?"#00CCFF":"black"}}>{val.title}</h5>
                            <p className="card-text" style={{color:props.theam === "dark"?"#F0F8FF":"black"}}>{val.description}</p>
                            <ul>
