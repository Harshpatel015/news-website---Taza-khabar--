...
function Top() {
  ...
  const [News,NextNews] = useState([])
    useEffect(()=>{
      axios.get("https://newsapi.org/v2/top-headlines?country=in&apiKey=c261f27321f04afbbc65e2e975aaef76").then((res) =>{
          ...
          <div className='container row my-2 mx-2'>
...

            {
              News.map((val)=>{
                ...
                let touch = <a href={val.url} class="btn btn-dark"> Read More </a>
